...
struct ContentView: View {
    ...
    @State private var colorScheme: ColorScheme = .dark // Add state for color scheme
    ...
    let fontSizes: [CGFloat] = [16, 18, 20, 22, 24, 26, 32, 36, 40]
    ...
    private let documentsDirectory: URL = {
        let directory = FileManager.default.urls(for: .documentDirectory, in: .userDomainMask)[0].appendingPathComponent("OffMind")
        
        // Create OffMind directory if it doesn't exist
        if !FileManager.default.fileExists(atPath: directory.path) {
            do {
                try FileManager.default.createDirectory(at: directory, withIntermediateDirectories: true)
                print("Successfully created OffMind directory")
            } catch {
    ...
    private func loadExistingEntries() {
        ...
        do {
            ...
            let hasOnlyWelcomeEntry = entries.count == 1 && entriesWithDates.first?.content.contains("Welcome to OffMind.") == true
                ...
                VStack {
                    ...
                    HStack {
                        ...
                        HStack(spacing: 8) {
                            ...
                            .buttonStyle(.plain)
                            .foregroundColor(isHoveringQuit ? textHoverColor : textColor)
                            .onHover { hovering in
